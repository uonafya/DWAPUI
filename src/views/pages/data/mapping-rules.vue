...
export default {
    ...
    methods: {
        ...
        comitDatimMOHCols() {
            ...
            axios.post("rules/cols/", data).then((res) => {
                console.log(res)
                Swal.fire({
                    title: "Success!",
                    icon: "success",
        ...
        updateDatimMOHCols() {
            ...
            axios.put("rules/cols/" + this.id + "/", data).then((res) => {
                console.log(res)
                Swal.fire({
                    title: "Success!",
                    icon: "success",
...
<template>
    <Layout>
        ...
        <div class="row">
            <div class="col-sm-4">
                <!-- rule1-->
                <vue-timeline-update :date="timeline1_last_updated" :title="timeline1_status"
                    description="Define at least one column from each dataset to be considered when mapping indicators"
                    thumbnail="/images/vuetimeline/initial_d.jpg" category="Dataset Columns" icon="pill"
                ...
                <div class="card mb-0">
                    <b-tabs content-class="p-4" justified class="nav-tabs-custom">
                        <b-tab :active="tab1">
                            ...
                            <b-card header="Columns" header-tag="header" footer="Columns" footer-tag="footer" title=""
                                header-class="bg-success text-white">
                                <div class="row">
                                    <b-card header="DATIM-MOH MAPPING COLUMNS" header-tag="header" footer="" footer-tag=""
                                        title="" header-class="bg-light text-success">
                                        <div class="col-sm-8">
                                            <b-input-group prepend="Datim Column Name" class="p-2">
                                                <b-form-input type="text" v-model="datim_col_name"
                                                    class="w-50"></b-form-input>
                                                <b-input-group-append>
                                                </b-input-group-append>
                                            </b-input-group>
                                            <b-input-group prepend="MOH Column Name" class="p-2">
                                                <b-form-input type="text" v-model="moh_col_name"
                                                    class="w-50"></b-form-input>
                                                <b-input-group-append>
                                                </b-input-group-append>
                                            </b-input-group>
                                        ...
                                        <div class="row p-2 mt-4">
                                            <div class="right">
                                                <b-button type="submit" variant="success" @click="comitDatimMOHCols()"
                                                    v-if="!editcols">Commit Configurations</b-button>
                                                <b-button type="submit" variant="success" @click="updateDatimMOHCols()"
                                                    v-if="editcols">Update Configurations</b-button>
                                            </div>
                                        </div>
                                    </b-card>
                                </div>
